# Contributing to uffbasse

First and foremost, thank you! I appreciate that you want to contribute to uffbasse, your time is valuable, and your contributions mean a lot to me.
...
**Showing support for uffbasse**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for uffbasse:

- star the [project](https://github.com/felixheck/uffbasse)
- tweet your support for uffbasse
...
- **version**: please note the version of uffbasse are you using
...
The original poster or the maintainer's of uffbasse may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/uffbasse